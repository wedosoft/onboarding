          ...
          {CATEGORIES.map(category => {
            ...
            return (
              <button
                ...
                className="glass-card rounded-xl p-6 text-left hover:bg-muted/50 transition-all border border-border hover:border-primary/30 group"
              >
                <div className="w-14 h-14 bg-muted rounded-xl flex items-center justify-center mb-4 group-hover:bg-primary/10 transition-colors">
                  <i className={`${category.icon} text-2xl text-muted-foreground group-hover:text-primary transition-colors`} />
                </div>
                ...
                <div className="w-full bg-muted rounded-full h-1.5 mt-2">
                  <div
                    className="bg-primary h-1.5 rounded-full transition-all shadow-[0_0_5px_hsl(var(--primary)/0.5)]"
    ...
    return (
      <div className="max-w-2xl mx-auto text-center">
        <div className="glass-card rounded-2xl p-8 relative overflow-hidden border border-border">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary via-blue-400 to-blue-600"></div>
          <div className="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-primary/20 shadow-[0_0_30px_hsl(var(--primary)/0.2)]">
          ...
          <p className="text-muted-foreground mb-8 text-lg">
            <strong className="text-primary">{categoryName}</strong> 카테고리의 모든 시나리오를 완료했습니다.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={handleBackToCategories}
              className="px-8 py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-xl transition-all shadow-lg hover:shadow-primary/50"
            >
              다른 카테고리 학습하기
            </button>
          </div>
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
          <div
            className="bg-primary h-2 rounded-full transition-all duration-300 shadow-[0_0_10px_hsl(var(--primary)/0.5)]"
