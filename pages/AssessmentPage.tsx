      ...
      <div className="grid md:grid-cols-2 gap-6">
        {tracks.map((track) => (
          <div
            ...
            className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 cursor-pointer hover:shadow-md hover:border-sky-300 dark:hover:border-sky-600 transition-all group"
          >
            {/* Icon */}
            <div className="w-14 h-14 rounded-xl bg-sky-100 dark:bg-sky-900/50 flex items-center justify-center mb-4 group-hover:bg-sky-200 dark:group-hover:bg-sky-800/50 transition-colors">
              <i className={`${track.icon} text-2xl text-sky-600 dark:text-sky-400`} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sky-600 dark:text-sky-400 text-sm font-medium group-hover:translate-x-1 transition-transform">
