...
const CompletionScreen: React.FC<CompletionScreenProps> = ({ onRestart, categoryName }) => {
  return (
    <div className="text-center glass-card rounded-2xl shadow-lg p-8 sm:p-12 animate-fade-in border border-white/10">
      ...
      <button
        onClick={onRestart}
        className="bg-primary-500 text-white font-bold py-3 px-8 rounded-lg hover:bg-primary-400 transition-all duration-200 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-primary-500/30"
      >
