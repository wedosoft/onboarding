...
const FeedbackModal: React.FC<FeedbackModalProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <header className="p-4 sm:p-6 border-b border-border flex justify-between items-center bg-muted/30">
        ...
        <footer className="p-4 sm:p-6 border-t border-border mt-auto flex justify-end bg-muted/30">
          <button
            onClick={onNext}
