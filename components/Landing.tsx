      ...
      <div className="w-full max-w-md mx-auto relative">
        ...
        <div className="text-center mb-8 relative z-10">
          <div className="flex justify-center items-center mb-4">
            {/* Wedosoft Logo Icon - Blue #3284d6 */}
            <svg
            ...
            >
              <defs>
                <style>{`.logo-blue{fill:#3284d6;}`}</style>
              </defs>
              <rect width="100" height="100" rx="20" className="logo-blue" />
              <g transform="translate(15, 20) scale(0.7)">
                <path fill="#ffffff" d="M50.68,1.19L20.1,29.57c-.9,.83-1.41,2-1.41,3.23v24.54c0,3.85,4.58,5.85,7.4,3.23l30.58-28.38c.9-.83,1.41-2,1.41-3.23V4.42c0-3.85-4.58-5.85-7.4-3.23Z" />
                <path fill="#ffffff" d="M90.08,1.19l-30.58,28.38c-.9,.83-1.41,2-1.41,3.23v24.54c0,3.85,4.58,5.85,7.4,3.23l30.58-28.38c.9-.83,1.41-2,1.41-3.23V4.42c0-3.85-4.58-5.85-7.4-3.23Z" />
                <circle fill="#ffffff" cx="11.6" cy="11.6" r="11.6" />
              </g>
            </svg>
          </div>
        ...
        {/* Login Card */}
        <div className="bg-card rounded-2xl p-8 relative z-10 border border-border shadow-xl">
          ...
          <button
            onClick={signIn}
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white hover:bg-slate-50 border border-border rounded-xl shadow-lg hover:shadow-xl transition-all group"
          >
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center relative z-10">
          ...
          <div className="p-4 bg-card rounded-xl border border-border">
            ...
            <p className="text-sm text-muted-foreground">멘토 채팅</p>
          </div>
          <div className="p-4 bg-card rounded-xl border border-border">
